Écrire une fonction qui indique si une année passée en paramètre est bissextile ou non. La fonction renvoie `True` si l'année est bissextile, `False` sinon. <BR>
